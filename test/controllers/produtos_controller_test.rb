...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { cpu: @produto.cpu, data: @produto.data, hd: @produto.hd, memoria: @produto.memoria, objeto: @produto.objeto, obs: @produto.obs, user_id: @produto.user_id, valor: @produto.valor } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { cpu: @produto.cpu, data: @produto.data, hd: @produto.hd, memoria: @produto.memoria, objeto: @produto.objeto, obs: @produto.obs, user_id: @produto.user_id, valor: @produto.valor } }
